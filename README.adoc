...
- provide more readable colors for the syntax highlighting by adding a ./src/css/stackoverflow-colors.css[custom CSS file] with the same colors used by Stack Overflow;
